var etat = {
    "inbox": [{
            "from": "Disd01",
            "date": "2022 12 28 20:15:42",
            "msg": "Saisir un message "
        },
        {
            "from": "Emi012",
            "date": "2022 02 15 20:15:51",
            "msg": "Un autre message ...."
        },
        {
            "from": "Moh015",
            "date": "2021 02 15 20:15:51",
            "msg": "Un autre message ...."
        }
    ],
    "outbox": [{
        "to": "Disd01",
        "date": "2020 02 12 13:15:42",
        "msg": "Ah ah aha aah "
    }],
    "yp": {
        "Disd01": { "name": "Duplex Arsene " },
        "Emi012": { "name": "Germaine " },
        "Mouya": { "name": "Mohamed " }
    }
};
...
function onButtonComposeClick() {
    ...
    content.push("	<table>");
    content.push(" 		<tr>");
    content.push("   		<td class='bold'> De: </td>");
    content.push("     		<td>");
    ...
    content.push("    		<td>");
    content.push("      		<textarea name='textarea-compose' cols='40' rows='5'>Entre ton message </textarea>");
    content.push("    		</td>");
    content.push("  	</tr>");
    content.push("  	<tr>");
    content.push("    		<td></td>");
    content.push("    		<td>");
    content.push("      		<input class='btn solid' type='submit' value='Send' />");
    content.push("    		</td>");
    content.push("  	</tr>");
    content.push("	</table>");
    content.push("</form>");
...
function onButtonInboxClick() {
    ...
    content.push(" <thead>");
    content.push("   <tr>");
    content.push("     <td>Adresse</td><td>Date</td>");
    content.push("   </tr>");
    content.push(" </thead>");
    content.push(" <tbody>");
...
/**
 * Fonction appelée quand le bouton Modifier_C est cliqué.
 */
function onButtonYpClick() {
    ...
    content.push(" <thead>");
    content.push("   <tr>");
    content.push("     <td>Address</td><td>Nom</td><td>Actions</td>");
    content.push("   </tr>");
    content.push(" </thead>");
    content.push(" <tbody>");
